---
title: "07-figs3-abundant-patterns"
...
params:
  name: "07-figs3-abundant-patterns"
---
...
#| include: false
params = list(name = "07-figs3-abundant-patterns")
```
...
cat("========================================================================\n")
cat("✅ Figure s3a: Abundant Viral Taxa (Bubble Plot)\n")
...
# Figure S3a: abundant viral-family bubble plot
stopifnot(exists("p_bubble"))

save_tiff(
  plot = p_bubble,
  filename = "FigS3a_abundant_family_bubble.tiff",
  width = 8.5,
  height = 6
)

# Figure S3b: host heatmap of abundant vOTUs
stopifnot(exists("p_heatmap"))

save_tiff(
  plot = p_heatmap,
  filename = "FigS3b_abundant_host_heatmap.tiff",
  width = 8,
  height = 3.0
)

message(
  "Figure S3 TIFF panels exported to: ",
