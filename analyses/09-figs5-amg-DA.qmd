...
#| include: false
params = list(name = "09-figs5-amg-DA")
```
...
stopifnot(exists("p_amg_da"))

ggplot2::ggsave(
  filename = file.path(
    tiff_dir,
    "FigS5_top20_candidate_AMG_DA_heatmap.tiff"
  ),
  plot = p_amg_da,
  device = "tiff",
  width = 8,
