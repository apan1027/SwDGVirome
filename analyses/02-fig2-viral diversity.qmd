...
The purpose of this document is to analyze and visualize viral alpha and beta diversity across different sample groups (depths), utilizing rarefaction curves, Venn diagrams, and taxonomic composition bar plots to reveal community structural differences.
...
save_tiff(
  p_fig2b,
  "Fig2b_rarefaction.tiff",
  width = 8,
  height = 10
)

# Fig. 2c — VennDiagram/grid object
grDevices::tiff(
  filename = file.path(tiff_dir, "Fig2c_venn.tiff"),
  width = 10,
  height = 10,
  units = "in",
  res = 600,
...
save_tiff(
  p_fig2d,
  "Fig2d_replication_strategy.tiff",
  width = 5,
  height = 6
)
...
save_tiff(
  p_fig2f,
  "Fig2f_imgvr_source_and_genus_summary.tiff",
  width = 7.8,
  height = 5
)
...
save_tiff(
  p_fig2g,
  "Fig2g_host_phylum.tiff",
  width = 6.7,
  height = 9
)

message("TIFF panels written to: ", tiff_dir)
```
