11-figs8-public-reference
================
today

**Updated: 2026-09-22 15:20:23 CET.**
...
<img src="data/11-figs8-public-reference/preview_png/FigS8_public_reference_coverage_compact.png" alt="" width="1370" />
\### Task 4: Export Table S2 public-reference matches

This table exports the archived sequence-match records. Figure S8
reports published coverage for the same six references; the two inputs
remain separate. No nucleotide alignment or read mapping is rerun here.
...
Äspö contigs.
    ...
    ## Verified Excel export: 9 representatives, 6 references; /Users/pan/Library/CloudStorage/OneDrive-HelmholtzZentrumMünchen/Documents/Project 6_Sweden water p0057/p0057projthis/SwDGVirome/analyses/data/11-figs8-public-reference/Table_S2_public_reference_matches.xlsx
...
|:---------------------------------------|:----------|------:|:--------------------|
| FigS8_input_manifest.csv               | file      |    83 | 2026-09-22 15:20:29 |
| FigS8_sessionInfo.txt                  | file      | 6.83K | 2026-09-22 15:20:29 |
| FigS8_values_used.csv                  | file      | 4.31K | 2026-09-22 15:20:29 |
| Table_S2_public_reference_matches.xlsx | file      | 8.85K | 2026-09-22 15:20:30 |
| preview_png                            | directory |    96 | 2026-09-22 14:51:32 |
| tiff_panels                            | directory |    96 | 2026-09-22 14:51:32 |
