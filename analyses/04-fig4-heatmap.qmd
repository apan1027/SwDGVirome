...
This document visualizes automated candidate-AMG annotation patterns using carrier-vOTU TPM and records the available ORF-level evidence. Pathway membership alone does not establish an auxiliary metabolic role.
