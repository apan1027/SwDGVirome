...
params:
  name: "08-figs4-rare-patterns"
---

**Updated: `r format(Sys.time(), '%Y-%m-%d %H:%M:%S', tz = 'CET')` CET.**

The purpose of this document is to investigate the "rare biosphere," examining the diversity, ecological drivers, and potential persistence of low-abundance viral populations.

```{r}
#| label: params
#| eval: !expr interactive()
#| include: false
params = list(name = "08-figs4-rare-patterns")
```
...
# Figure S4a: rare viral-family bubble plot
stopifnot(exists("p_bubble"))

save_tiff(
  plot = p_bubble,
  filename = "FigS4a_rare_family_bubble.tiff",
  width = 8.5,
  height = 6
)

# Figure S4b: host heatmap of rare vOTUs
stopifnot(exists("p_heatmap"))

save_tiff(
  plot = p_heatmap,
  filename = "FigS4b_rare_host_heatmap.tiff",
  width = 8,
  height = 10
)

message(
  "Figure S4 TIFF panels exported to: ",
