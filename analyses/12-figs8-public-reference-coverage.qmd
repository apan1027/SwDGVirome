---
title: "12-figs8-public-reference-coverage"
date: today
params:
  name: "12-figs8-public-reference-coverage"
---
...
#| include: false
params = list(name = "12-figs8-public-reference-coverage")
```
```{r}
#| label: setup
#| message: false
...
here::i_am(paste0(params$name, ".qmd"), uuid = "8602892f-9857-41d3-a09e-a330754ce87a")
